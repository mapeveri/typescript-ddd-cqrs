import DeleteExpressionOnTermCreatedFailedEventHandler from '@src/languages/application/term/event/delete/deleteExpressionOnTermCreatedFailedEventHandler';
...
import DeleteWordOnTermCreatedFailedEventHandler from '@src/languages/application/term/event/delete/deleteWordOnTermCreatedFailedEventHandler';
